...
def home():
    ...
    return render_template("response.html", data=routes_data)
...
def precipitation():
    ...
    return render_template("response.html", data=precipitation_data)
...
def stations():
    ...
    return render_template("response.html", data=stations_list)
...
def tobs():
    ...
    return render_template("response.html", data=tobs_data)
...
def start(start=None):
    if request.method == "POST":
        ...
        # Query for all dates greater than or equal to the start date
        ...
        return render_template("response.html", data=temp_stats)
...
def start_end(start=None, end=None):
    if request.method == "POST":
        ...
        # Query for all dates between the start and end dates, inclusive
        results = (
            session.query(*query)
